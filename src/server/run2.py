...
# dataset_names = ['cifar10', 'svhn', 'medmnistA', 'fmnist', 'mnist', 'cifar100', 'tiny_imagenet', 'cinic10', 'emnist']
# dataset_names = ['svhn', 'cifar100', 'tiny_imagenet', 'mnist', 'cinic10', 'emnist']
# dataset_names = ['cifar10', 'medmnistA', 'fmnist']
dataset_names = ['tiny_imagenet']
...
# 拼接要执行的 Python 脚本的路径
script_path = os.path.join(current_directory, "fedsper2.py")

# 循环执行各个数据集的命令
for dataset_name in dataset_names:
    cmd = f"{python_path} {script_path} --dataset {dataset_name} --global_epoch 200 --join_ratio 0.1"
